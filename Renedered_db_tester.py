...
for cntr in range(num_of_chunks):
    ...
    file = 'C:\\Users\\vgliner\\OneDrive - JNJ\\Desktop\\Data\\Rendering_to_class_db\\' + "Rendered_data" + str(
        cntr + 1) + ".pkl"
...
ECG_test = ECG_Multilead_Dataset(root_dir=r'C:\Users\vgliner\OneDrive - JNJ\Desktop\Data' + '\\', transform=None,
